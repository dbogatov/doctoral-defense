\section{\epsolute{}: Efficiently Querying Databases While Providing Differential Privacy~\cite{epsolute}}
	...
	\begin{frame}{Experiments: against other mechanisms}
		...
		\begin{figure}[h]
			\centering
			\includegraphics[width=0.8\textwidth]{mechanism}
			\caption{
				\centering
				Different range-query mechanisms (log scale). \hspace{\textwidth} % hack
	...
	\begin{frame}{Experiments: scalability}
		...
		\begin{figure}[h]
			\centering
			\includegraphics[width=0.9\columnwidth]{scalability}
